...
class _SignUpPage1State extends State<SignUpPage1> {
  ...
  // Error state for non-form fields
  ...
  Future<void> _pickDate() async {
    ...
    if (picked != null) {
      setState(() {
        ...
        _showDobError = false; // clear error on selection
  ...
  void _goToNext() {
    ...
    if (!isFormValid || _showDobError || _showGenderError || _showBloodGroupError) {
      return;
    }
                  ...
                  child: Row(
                    children: [
                      Icon(
                        ...
                        color: _showDobError ? Colors.red : const Color(0xFF1565C0),
                        size: 20,
                      ),
                  ...
                  return Expanded(
                    child: GestureDetector(
                      onTap: () => setState(() {
                        ...
                        _showGenderError = false; // clear error on selection
                      }),
                      child: Container(
                ...
                children: _bloodGroups.map((group) {
                  ...
                  return GestureDetector(
                    onTap: () => setState(() {
                      ...
                      _showBloodGroupError = false; // clear error on selection
                    }),
                    child: Container(
                      width: 68,
